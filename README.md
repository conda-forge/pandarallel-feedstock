...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandarallel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12994&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandarallel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandarallel` can be installed with:

```
conda install pandarallel
```

It is possible to list all of the versions of `pandarallel` available on your platform with:
